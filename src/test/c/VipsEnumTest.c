...
Java_com_criteo_vips_VipsEnumTest_TestNativeEnums(JNIEnv *env, jclass c)
{
    ...
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_UCHAR, "com/criteo/vips/enums/VipsBandFormat", "Uchar");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_CHAR, "com/criteo/vips/enums/VipsBandFormat", "Char");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_USHORT, "com/criteo/vips/enums/VipsBandFormat", "Ushort");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_SHORT, "com/criteo/vips/enums/VipsBandFormat", "Short");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_UINT, "com/criteo/vips/enums/VipsBandFormat", "Uint");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_INT, "com/criteo/vips/enums/VipsBandFormat", "Int");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_FLOAT, "com/criteo/vips/enums/VipsBandFormat", "Float");
    ...
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_PARTIAL, "com/criteo/vips/enums/VipsFormatFlags", "Partial");
    assertEqualsNativeEnumValue(env, VIPS_FORMAT_BIGENDIAN, "com/criteo/vips/enums/VipsFormatFlags", "Bigendian");
